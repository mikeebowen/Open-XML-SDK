...
namespace DocumentFormat.OpenXml.Spreadsheet
{
    ...
    {
        private TableColumnExtensionList? _tableColumnExtLst = null;
        ...
        {
            get => this._tableColumnExtLst;
            set => this._tableColumnExtLst = (TableColumnExtensionList?)value;
        }
        ...
        {
            //get => (TableColumnExtensionList?)GetElement<ExtensionList>();
            get
            {
                ExtensionList? extList = GetElement<ExtensionList>();
               ...
               return this._tableColumnExtLst ??= new TableColumnExtensionList(extList);
        ...
        public partial class TableColumnExtensionList : ExtensionList
        {
            ...
            /// </summary>
            public TableColumnExtensionList(ExtensionList extLst)
            {
                if (extLst is null)
                {
                    throw new ArgumentNullException(nameof(extLst));
                }

                foreach (var child in extLst)
                {
